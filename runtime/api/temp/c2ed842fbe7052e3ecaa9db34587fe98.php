<?php /*a:1:{s:67:"C:\xampp\htdocs\ThinkPHPProject\tp\app\api\view\register\index.html";i:1619690778;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="layui-container">
    <form action="" class="layui-form layui-col-md4 login-background" style="width:350px;height: 350px;">
        ...
        <button class="layui-btn login-button" lay-submit="" lay-filter="register" style="background-color:#126e82">Register</button>
    </form>
...
<script src="/ThinkPHPProject/tp/public/static/api/js/register.js"></script>
</body>
</html>